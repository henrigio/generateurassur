...
public class GenerateurassurApp {

    private static final Logger log = LoggerFactory.getLogger(GenerateurassurApp.class);

    private final Environment env;

    public GenerateurassurApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes generateurassur.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GenerateurassurApp.class);
